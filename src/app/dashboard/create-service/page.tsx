...
export default function CreateServicePage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!session?.user?.accessToken) {
            setMessage("Нэвтэрсэн хэрэглэгчийн токен алга байна. Та нэвтэрч ороод дахин оролдоно уу.");
            return;
        }
        ...
        if (price < 0) {
            setMessage("Үнэ сөрөг утгатай байж болохгүй.");
            return;
        }
            ...
            <div className="flex-1 p-6">
                <div className="max-w-lg mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        {/* Service Name */}
                        <div>
                            <label htmlFor="serviceName" className="block mb-1 text-sm font-semibold text-gray-700">
                        ...
                        {/* Duration */}
                        <div>
                            <label htmlFor="duration" className="block mb-1 text-sm font-semibold text-gray-700">
                                <div className="flex items-center gap-1">
